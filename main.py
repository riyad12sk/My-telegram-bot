...
# BOT TOKEN
# ==================================================
BOT_TOKEN = "8717201146:AAEG1IqrDOUEFsnJHcxNKMBJBF0nG4nEH2E"
...
def retry_keyboard():
    ...
    # সব Channel-এর Join button আবার দেখাবে
    for channel in REQUIRED_CHANNELS:
        rows.append([
            InlineKeyboardButton(
                channel["name"],
...
async def button_handler(
    ...
    if query.data == "start_verify":
        ...
        await query.edit_message_text(
            ...
            "নিচের সবগুলো Channel-এ Join করুন।\n\n"
            "✅ সবগুলো Channel-এ Join করার পর "
    ...
    if query.data == "verify":
        ...
        if verified:
            ...
            await query.edit_message_text(
                ...
                "🔐 এখন নিচের Private Channel-এ "
                "Join Request পাঠান।\n\n"
                "📨 Request পাঠানোর পর Admin আপনার "
                "Request চেক করে আপনাকে Add করবেন।\n\n"
                "👇 নিচের বাটনে চাপ দিন:",
        ...
        # ------------------------------------------
            ...
            await query.edit_message_text(
                "❌ Verification Failed\n\n"
                "আপনি এখনো সবগুলো Required Channel-এ "
                "Join করেননি।\n\n"
                "দয়া করে উপরের সবগুলো Channel-এ Join করুন, "
                "তারপর আবার Verify করুন।",
...
async def join_request_handler(
    ...
    # শুধু নির্দিষ্ট Private Channel-এর request গ্রহণ
    ...
    try:
        await context.bot.send_message(
            chat_id=user.id,
            text=(
                "📨 আপনার Private Channel Join Request "
                "পাওয়া গেছে।\n\n"
                "⏳ Admin আপনার Request চেক করে "
                "আপনাকে Add করবেন।\n\n"
